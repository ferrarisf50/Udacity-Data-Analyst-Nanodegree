...
object Xgboost{
  ...
  def main(args: Array[String]) {
    ...
    var train_data = load("../path+my.csv/train_full_parsed_clean6.csv",
      sqlContext).cache()
    ...
    def topcoordinates(line:String)={
